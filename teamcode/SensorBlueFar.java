...
@Autonomous(name="SensorBlueFar", group = "AutoOp", preselectTeleOp = "atMainTeleOp")
//@Autonomous(name="BlueFarDuckyAuto")\

public class SensorBlueFar extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        initTfod();
        double objectDistance = robot.sensorDistance.getDistance(DistanceUnit.INCH);
...
//                .back(5.5)
                ...
                .strafeLeft(30)
                .build();
        TrajectorySequence scoreAfterAllClear = autoDrive.trajectorySequenceBuilder(scoreFromLeftSpike.end())
...
//                requestOpModeStop();
        ...
        objectDistance = robot.sensorDistance.getDistance(DistanceUnit.INCH);
        while(objectDistance < 20) {
            objectDistance = robot.sensorDistance.getDistance(DistanceUnit.INCH);
        }
        autoDrive.followTrajectorySequence(scoreAfterAllClear);
    }
