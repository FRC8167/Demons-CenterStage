...
@Config
@Disabled
@TeleOp(name="TestAprilTagsV3", group="Test")
public class TEST2A_AprilTags extends RobotBase_Demons {
    ...
    public static double RANGE_OFFSET   = 12.5;
...
//                telemetry.addData("Id: ", tag.id);
    ...
    public double[] shootPidApproach(AprilTagDetection targetTag) {
        ...
        cmds[2] = (KP_YAW * yawError + KD_YAW * (yawError - lastTargetErr[2]) / deltaT + KF_YAW); // * Math.cos(Range.clip(Math.toRadians(yawError), -Math.PI/2, Math.PI/2));
